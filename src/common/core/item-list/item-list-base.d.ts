...
import { IFindItemResult, IItemBase, IItemTree, IParentListInfoResult, ItemListService, IViewListResult, ViewportMode, ViewPortService } from './index';
export declare abstract class ItemListBase {
    ...
    protected readonly abstract listElement: HTMLElement;
    ...
    setSelectingItem(fn: (item: IItemBase) => Promise<IItemBase> | Observable<IItemBase>): void;
    setUnselectingItem(fn: (item: IItemBase) => Promise<IItemBase> | Observable<IItemBase>): void;
