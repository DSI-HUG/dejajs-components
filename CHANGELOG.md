...
* **DatePickerComponent:** Add button type to avoid involuntary form submit ([f507e1e](https://github.com/DSI-HUG/dejajs-components/commit/f507e1e))
...
* **DejaDatePicker:** Fix Maximum call stack size exceeded error ([4a8fad4](https://github.com/DSI-HUG/dejajs-components/commit/4a8fad4))
...
* **DejaDatePickerComponent:** Remove debug console.log ([c46edaa](https://github.com/DSI-HUG/dejajs-components/commit/c46edaa))
...
* **DejaOverlay:** Fix overlay container visibility during printing ([f19fef4](https://github.com/DSI-HUG/dejajs-components/commit/f19fef4))
...
* **DejaPopup:** Fix width for custom component in popup ([2f1c5ed](https://github.com/DSI-HUG/dejajs-components/commit/2f1c5ed))
...
* **Global:** Change npm with yarn in critical points ([9e2c61f](https://github.com/DSI-HUG/dejajs-components/commit/9e2c61f))
...
* **Global:** Update dependencies for [@angular](https://github.com/angular) 6.0.0-rc.4, and RxJs 6 ([b896e03](https://github.com/DSI-HUG/dejajs-components/commit/b896e03))
* **Global:** Update dependencies for [@angular](https://github.com/angular) 6.0.0-rc.4, and RxJs 6 ([f27e58d](https://github.com/DSI-HUG/dejajs-components/commit/f27e58d))
* **Global:** Updated dependencies for ng6, RxJs 6 and Gulp 4 ([4668352](https://github.com/DSI-HUG/dejajs-components/commit/4668352))
* **Global:** Updated dependencies for ng6, RxJs 6 and Gulp 4 ([e812fd1](https://github.com/DSI-HUG/dejajs-components/commit/e812fd1))
...
* **package.json:** Align nodejs version to [@angular-devkit](https://github.com/angular-devkit)/core ([bd7018b](https://github.com/DSI-HUG/dejajs-components/commit/bd7018b))
* **RxJs:** Added RxJs compat and uptaed to RxJs 6 ([2e85073](https://github.com/DSI-HUG/dejajs-components/commit/2e85073))
...
* **TreeList:** Fix null pointer for null ItemListService ([772a6e6](https://github.com/DSI-HUG/dejajs-components/commit/772a6e6))
...
* **Webpack:** Rollback Webpack 4 and Karma 4 temporarily because bad performances for unit test ([7283183](https://github.com/DSI-HUG/dejajs-components/commit/7283183))
* **Webpack:** Rollback Webpack 4 and Karma 4 temporarily because bad performances for unit test ([b3b2228](https://github.com/DSI-HUG/dejajs-components/commit/b3b2228))
* List item alignment was not preserved if the item content was too long ([b3ffd06](https://github.com/DSI-HUG/dejajs-components/commit/b3ffd06))
* Missing license ([95b37cf](https://github.com/DSI-HUG/dejajs-components/commit/95b37cf))
* Revert view encapsulation modification ([cf14713](https://github.com/DSI-HUG/dejajs-components/commit/cf14713))
* Set tab index to -1 for button to prevent unexpected behavior on form ([7722ce5](https://github.com/DSI-HUG/dejajs-components/commit/7722ce5))
...
* **DejaIntervalSelectorComponent:** remove interval selector component (moved to dejajs-dpi) ([894cf43](https://github.com/DSI-HUG/dejajs-components/commit/894cf43))
...
* **ItemList:** Restore query from ItemListService if an external instance is used. ([3f7fa51](https://github.com/DSI-HUG/dejajs-components/commit/3f7fa51))
...
* **MatIconService:** service to register SVG icons to MatIconRegistry so that custom SVG icons can be used with MatIcon component, i.e <mat-icon svgIcon='deja-icon' /> ([17d1938](https://github.com/DSI-HUG/dejajs-components/commit/17d1938))
...
* **DejaIntervalSelectorComponent:** removed and moved to dejajs-dpi
